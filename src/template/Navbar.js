                        ...
                        <div className="container-fluid bg-dark">
                            ...
                            <div className="collapse navbar-collapse" id="admin-navbar-content">
                                <ul className="navbar-nav me-auto me-lg-0 ms-lg-auto mb-2 mb-lg-0">
                                    ...
                                    <li className="nav-item">
                                        <Link to={Config.Links.Medicines} className="nav-link text-white">
                                    ...
                                    <li className="nav-item">
                                        <Link to={Config.Links.MedicalRecords} className="nav-link text-white">
                                            <p className="m-0">Rekam Medis</p>
                                        </Link>
                                    </li>}
                                    {AdminRole(context.admin, Config.Routers.Receipts) &&
                                    <li className="nav-item">
                                        <Link to={Config.Links.Receipts} className="nav-link text-white">
                                            <p className="m-0">Resep</p>
                                        </Link>
                                    </li>}
